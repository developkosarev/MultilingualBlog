 ...
 */
final class Version20201004201256 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE accum_cost_total (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, period_date DATETIME NOT NULL, quantity NUMERIC(10, 3) NOT NULL, cost NUMERIC(10, 2) NOT NULL, INDEX IDX_582A66944584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE accum_stock_total (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, warehouse_id INT NOT NULL, period_date DATETIME NOT NULL, quantity NUMERIC(10, 3) NOT NULL, reserved_quantity NUMERIC(10, 3) NOT NULL, INDEX IDX_222295294584665A (product_id), INDEX IDX_222295295080ECDE (warehouse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ref_product (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(10) NOT NULL, name VARCHAR(50) NOT NULL, version INT DEFAULT 1 NOT NULL, marked TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE accum_cost DROP FOREIGN KEY FK_6F3EEDF383D48C68');
        ...
        $this->addSql('ALTER TABLE accum_cost DROP FOREIGN KEY FK_6F3EEDF3D4E0264C');
        ...
        $this->addSql('ALTER TABLE accum_cost DROP FOREIGN KEY FK_6F3EEDF34584665A');
        $this->addSql('ALTER TABLE accum_cost_total DROP FOREIGN KEY FK_582A66944584665A');
