 ...
 */
final class Version20200725101937 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE doc_invoice (id INT AUTO_INCREMENT NOT NULL, date DATETIME NOT NULL, version INT DEFAULT 1 NOT NULL, marked TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
